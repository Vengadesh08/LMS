...
$sql = "SELECT ass_name, ass_doc, ass_ques, ass_dl FROM assign_adv";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES["ass_doc"]["tmp_name"], $uploadFile)) {
        ...
        $insertSql = "INSERT INTO ass_sub_adv (ass_name, EmailAddress, ass_date, ass_doc) VALUES ('$ass_name', '$student_email', '$ass_date', '$uploadFile')";
...
<body>
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<p><strong>Assignment Documents:</strong> <a href="' . $row['ass_doc'] . '" target="uploads1">Open/Download Document</a></p>';
            echo '<p><strong>Assignment Questions:</strong> ' . $row['ass_ques'] . '</p>';
            echo '<p><strong>Deadline:</strong> ' . $row['ass_dl'] . '</p>';
           
            
            echo '<form class="assignment-form" action="ass_fetch_adv.php" method="post" enctype="multipart/form-data">';
...
<div class="footer-content">
    ...
    <div class="footer-contact">
        ...
        <ul class="uk-list uk-list-hyphen">
            <li class="text-cray">Email: vengadesh358@gmail.com</li>
            <li class="text-cray">Phone: +91 7538831121</li>
        </ul>
    </div>
    </div>
<hr><div class="footer-copyright uk-text-center">
    Developed by Vengadesh| Sri Krishna college 
</div>
</div>
</footer>
</body>
