...
$sql = "SELECT ass_name, ass_doc, ass_ques, ass_dl FROM ass_int";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES["ass_doc"]["tmp_name"], $uploadFile)) {
        ...
        $insertSql = "INSERT INTO ass_sub_int (ass_name, EmailAddress, ass_date, ass_doc) VALUES ('$ass_name', '$student_email', '$ass_date', '$uploadFile')";
